...
const FlashcardSetCard = ({flashcardSet}) => {
  ...
  return <div
    className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-200 rounded-2xl p-6 cursor-pointer "
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className='text-xs font-medium text-slate-500 uppercase tracking-wide'></p>
        </div>
...
{totalCards > 0 && (
  <div className="space-y-2">
    ...
    <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
      <div
        className="absolute inset-y-0 left-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-in-out "
